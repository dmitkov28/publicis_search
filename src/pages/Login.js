...
export default function LoginPage() {
  ...
  return (
    <>
      <Grid container sx={{ height: '100vh', alignItems: 'flex-start' }} rowSpacing={0}>
        ...
        <Grid item xs={12} sx={{ mt: 10, p: 0 }} >
          ...
          >
            <SearchIcon fontSize='large' sx={{ color: '#dfe1e5', mr: 2, fontSize: { md: 75, sm: 55 } }} />
            <TypeAnimation
              sequence={['Publicis', 500, 'Publicis Search', 1000, 'Publicis Search Intelligence', 750]}
        ...
        <Grid item xs={12} md={6} sx={{ display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
          <Slide direction="right" in={true} timeout={1200} mountOnEnter unmountOnExit>
            <LoginImage component='img' title='Welcome Page Logo' />
          </Slide>
        </Grid>

        <Grid item xs={12} md={6} sx={{ display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
          <Slide direction="left" in={true} timeout={1200} mountOnEnter unmountOnExit>
